...
class BaseDatos
{
    ...
    public function verEmpresaRegistrar($ruc)
    {
        $consulta = "SELECT * FROM `empresa` as e where (e.eliminada = 1 AND e.ruc = $ruc);";
        $res = mysqli_query($this->con, $consulta);
        return $res;
    }
    ...
    {
        $consulta = "update empresa as e set id_grupo = '$id_grupo',tipo_persona = '$tipo_persona',ruc = '$ruc',razon_social = '$razon_social',nom_comercial = '$nom_comercial',direccion ='$direccion',id_ubigeo ='$id_ubigeo',id_rubro = '$id_rubro',id_tipo_sistema = '$id_tipo_sistema',id_tipo_integracion = '$id_tipo_integracion',tipo_envio = '$tipo_envio',estado='$estado',estado_comercial = '$estado_comercial',proveedor = '$proveedor',imglogo = '$bandera' where (e.id = '$id');";
